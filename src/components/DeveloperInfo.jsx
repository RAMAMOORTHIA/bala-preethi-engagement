  ...
  return (
    ...
    >
      <div className="developer-info">
        ...
        📩 <a href="mailto:rav" className="email-link">Want a site like this? Let's make it happen.</a>
        </p>
        <div className="social-links">
        <MdEmail className="social-icon" onClick={()=>
          window.open("https://mail.google.com/mail/?view=cm&fs=1&to=ramayyanar2000@gmail.com&su=Let's%20Build%20a%20Website&body=Hi%20Ram%2C%0AI%20like%20your%20work!")
          }/>
          <FaInstagram className="social-icon" onClick={()=>window.open("https://www.instagram.com/ram_ayyanar_/")}/>
          <FaPhone className="social-icon" onClick={() => window.open("tel:+916383703800")}/>
        </div>
